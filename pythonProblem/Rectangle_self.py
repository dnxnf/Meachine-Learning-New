...
@File     ：Rectangle_self.py
@Describe ：PyCharm 
@Author   ：Hello World
@Date     ：2025/5/27 下午8:43
题目描述
...
rectangle = []
rectangle.append((x1, y1, w1, h1))
rectangle.append((x2, y2, w2, h2))
rectangle.append((x3, y3, w3, h3))
print(compute_intersection_area(rectangle))
