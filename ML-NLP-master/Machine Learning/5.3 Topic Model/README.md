...
- ![img](https://latex.codecogs.com/gif.latex?w)表示词，![img](https://latex.codecogs.com/gif.latex?V)示所有单词的个数（固定值）。
- ![img](https://latex.codecogs.com/gif.latex?z) 表示主题，![](https://latex.codecogs.com/gif.latex?k)主题的个数（预先给定，固定值）。
